...
class RootViewModel {
  ...
  constructor() {
    ...
    const navData = [
      ...
      { path: "dashboard", detail: { label: "Restaurants", iconClass: "oj-ux-ico-bar-chart" } },
      { path: "incidents", detail: { label: "Warehouses", iconClass: "oj-ux-ico-fire" } }
    ];
    // router setup
    ...
    this.appName = ko.observable("Restaurant Inventory Management");
